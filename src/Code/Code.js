...
const navClassNames = "navbar sticky-top navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body";
    ...
    const existingUser = (arr) => {
       return (arr.username === userLogin.uname && arr.repassword === userLogin.upass);
      };
    ...
    const handleLogin = (e) => {
        ...
        axios({
            ...
            axios.get(url).then((res) => {
              console.log(res);
                const isUserExist = (res.data.filter(existingUser).length >=1);
                if (isUserExist) {
    ...
    return {
        signUp, setSignUp,showLoginModal, setShowLoginModal,showSignupModal, setShowSignupModal,
        userLogin, setUserLogin, navigate, arr, setArr, url, existingUser, handleSignup, handleLogin,
        handleSignUpChange, handleLoginChange, errors, setErrors, contactContent, biTelephone,
        biEnvelope, biMessenger, contactInfo, emailInfo, messengerInfo, aboutIframe, aboutContent,
        addToCart, cartCount, setCartCount,cartUrl, pcUrl, videoGameUrl, gamingPhoneUrl, PurchUrl,
        view, setView, prod, setProd, viewItem, setViewItem, expandedDesc, setExpandedDesc,
        ...
        showSuccess, setShowSuccess, paymentMethod,  pcImages, gPhoneImages, gamingPhone,  setGamingPhone, 
        ...
        handleSearch, handleSignOut, handleCloseModal, biFB, biInstagram, whiteEnvlop, biTweet, biYoutube
